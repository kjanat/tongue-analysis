...
6 React components, flat structure. ~1,591 lines total. All styles in `src/App.css`.

## WHERE TO LOOK

| File                   | Lines | Role                                                                                                      |
| ---------------------- | ----- | --------------------------------------------------------------------------------------------------------- |
| `CameraCapture.tsx`    | 962   | Modal dialog: live camera, still capture, device switching, real-time analysis. Orchestrates all 4 hooks. |
